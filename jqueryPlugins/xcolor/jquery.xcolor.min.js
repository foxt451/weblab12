...
(function (h, k) {
  function e(a) {
    ...
    function b(a, b, c) {
      ...
      c = c + c - b;
      return [
        Math.round(255 * e(c, b, a + 1 / 3)),
        Math.round(255 * e(c, b, a)),
        Math.round(255 * e(c, b, a - 1 / 3)),
      ];
    }
    function c(a, b, c) {
      ...
      const l = Math.round(255 * c * (1 - b * n));
    ...
    this.setColor = function (a) {
      ...
      if ('number' === typeof a) {
        ...
        if ('string' === typeof a) {
          ...
          if (
            (f = /^rgba?\((\d{1,3}),(\d{1,3}),(\d{1,3})(,([0-9.]+))?\)$/.exec(
              a
            ))
          ) {
            this.a = d(f[5], 1);
    ...
    this.getRGB = function () {
      return this.c ? { r: this.r, g: this.g, b: this.b, a: this.a } : null;
    };
    ...
    this.getFraction = function () {
      return this.c
        ? { r: this.r / 255, g: this.g / 255, b: this.b / 255, a: this.a }
        : null;
    };
    ...
    this.getHex = function () {
      return this.c
        ? '#' +
            '0123456789abcdef'.charAt(this.r >> 4) +
            '0123456789abcdef'.charAt(this.r & 15) +
            '0123456789abcdef'.charAt(this.g >> 4) +
            '0123456789abcdef'.charAt(this.g & 15) +
            '0123456789abcdef'.charAt(this.b >> 4) +
            '0123456789abcdef'.charAt(this.b & 15)
        : null;
    };
      ...
      return this.c
        ? k !== a
          ? (((100 * this.a) | 0) << 24) ^
            ...
            (this.g << 8) ^
            this.b
          : ((this.r << 16) ^ (this.g << 8) ^ this.b) & 16777215
        : null;
    };
  ...
  function s(a, d) {
    ...
    do {
      if (
        ((b = h.css(a, d)),
        ('' !== b && 'transparent' !== b && 'rgba(0, 0, 0, 0)' !== b) ||
          h.nodeName(a, 'body'))
      ) {
        break;
      }
  ...
  var q = {
    ...
    r;
  h.each(
    'color backgroundColor borderColor borderTopColor borderBottomColor borderLeftColor borderRightColor outlineColor'.split(
      ' '
    ),
    (a, d) => {
      h.cssHooks[d] = {
        ...
        if (k === a.xinit) {
          if ('string' === typeof a.end && -1 !== a.end.indexOf(';')) {
            ...
            if (2 < g.length) {
              for (c in g) {
                g[c] =
                  -1 === g[c].indexOf('native') ? new e(g[c]) : s(a.elem, d);
              }
              a.start = null;
              a.end = g;
            } else {
              (a.start = new e(g[0])), (a.end = new e(g[1]));
            }
          } else {
            (a.start = s(a.elem, d)), (a.end = new e(a.end));
          }
          a.xinit = 1;
        }
        c = a.start;
  ...
  h.xcolor = new (function () {
    ...
    this.sepia = function (a) {
      ...
      if (a.c) {
        ...
        a.b = Math.round(0.272 * d + 0.534 * b + 0.131 * c);
        return a;
      }
      return null;
    };
    ...
    this.opacity = function (a, d, b) {
      ...
      return a.c & d.c
        ? (1 < b && (b /= 100),
          (b = Math.max(b - 1 + d.a, 0)),
          (a.r = Math.round((d.r - a.r) * b + a.r)),
          (a.g = Math.round((d.g - a.g) * b + a.g)),
          (a.b = Math.round((d.b - a.b) * b + a.b)),
          a)
        : null;
    };
    ...
    this.webround = function (a) {
      a = new e(a);
      return a.c
        ? (255 < (a.r += 51 - (a.r % 51)) && (a.r = 255),
          255 < (a.g += 51 - (a.g % 51)) && (a.g = 255),
          255 < (a.b += 51 - (a.b % 51)) && (a.b = 255),
          a)
        : null;
    };
    ...
    this.readable = function (a, d, b) {
      ...
      return d.c & a.c
        ? ((a =
            ...
            0.114 * d.b),
          !(
            a < 1.5 + 141.162 * Math.pow(0.975, b) &&
            a > -0.5 - 154.709 * Math.pow(0.99, b)
          ))
        : null;
    };
    ...
    this.gradientlevel = function (a, d, b, c) {
      ...
      d = new e(d);
      return a.c & d.c
        ? ((a.r = (a.r + ((d.r - a.r) / c) * b) | 0),
          (a.g = (a.g + ((d.g - a.g) / c) * b) | 0),
          (a.b = (a.b + ((d.b - a.b) / c) * b) | 0),
          a)
        : null;
    };
    ...
    this.analogous = function (a, d, b) {
      ...
      if (c.c) {
        ...
        b = 360 / b;
        c = [c];
        for (a.h = (a.h - ((b * d) >> 1) + 720) % 360; --d; ) {
          (a.h += b), (a.h %= 360), c.push(new e(a));
        }
        return c;
      }
      return null;
    ...
    this.complementary = function (a) {
      a = new e(a);
      return a.c
        ? ((a = a.getHSL()), (a.h = (a.h + 180) % 360), new e(a))
        : null;
    };
    ...
    this.monochromatic = function (a, d) {
      ...
      var b = new e(a);
      if (b.c) {
        for (var c = b.getHSV(), b = [b]; --d; ) {
          (c.v += 20), (c.v %= 100), b.push(new e(c));
        }
        return b;
      }
      return null;
  ...
  h.fn.readable = function () {
    ...
    do {
      if (
        ('' !== d ||
          ('transparent' !== (d = h.css(a, 'color')) &&
            'rgba(0, 0, 0, 0)' !== d) ||
          (d = ''),
        '' !== b ||
          ('transparent' !== (b = h.css(a, 'backgroundColor')) &&
            'rgba(0, 0, 0, 0)' !== b) ||
          (b = ''),
        ('' !== d && '' !== b) || h.nodeName(a, 'body'))
      ) {
        break;
      }
    } while ((a = a.parentNode));
  ...
  h.fn.colorize = function (a, d, b) {
    ...
    this.each(function () {
      let c = this.childNodes,
        ...
        h = 0;
      if (a.c & d.c) {
        for (let k = c.length; k--; e += c[k].textContent.length);
        (function l(c) {
          let g = 0,
            k;
          if (3 === c.nodeType) {
            ...
            for (g = 0; g < k; ++g) {
              (u = document.createElement('span')),
                ...
                u.appendChild(document.createTextNode(w)),
                v.appendChild(u),
                ++h;
            }
            c.parentNode.replaceChild(v, c);
          } else {
            for (k = c.childNodes.length; g < k; ++g) l(c.childNodes[g]);
          }
        })(this);
      }
    });
